...
def main():
    ...
    # Define your stock cluster - technology sector stocks
    tech_stocks = ['AAPL', 'MSFT', 'GOOGL', 'AMZN', 'META', 'NVDA', 'AMD', 'INTC']
    print(f"Processing stock cluster: {', '.join(tech_stocks)}")
    ...
    if alreadygot:
        ...
        cluster_data = get_cluster_data(
            tech_stocks,
            start_date='2018-01-01',  # Using 5 years of data
            end_date='2023-12-31'
        )
    ...
    # Create sequences for the whole cluster
    ...
    # Use a simple time-based train/val split (80/20)
    ...
    print("Training complete! Model saved as tech_cluster_model.pth")
